...
class Styler(object):
    ...
    * Data cells include ``data``
    ...
    # PackageLoader returns unregistered loader type exception,  use FileSystemLoader instead
    template_file_name = 'html.tpl'
    template_file_path = resource_path('templates', template_file_name)
    template_file_directory = os.path.dirname(template_file_path)
    loader = FileSystemLoader(searchpath=template_file_directory)
